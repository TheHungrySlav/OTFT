...
prompt = "What is the name of your excel file?: ";
filename = input(prompt,"s");
prompt = "What number sheet is your data on?: ";
sheet = input(prompt);
prompt = "What is the cell range for IDS?: ";
xlRange = input(prompt,"s");
prompt = "What is the cell range for VGS?: ";
xlRange2 = input(prompt,"s");
prompt = "What is your vaule for VDS?: ";
VDS = input(prompt);
...
prompt = "Please title your graph: ";
